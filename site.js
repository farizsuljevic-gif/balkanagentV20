(() => {
  ...
  // Complete fields that were previously falling back to English.
  Object.assign(translations.mk,{f1p:'Моментални одговори врз основа на информациите, услугите и честите прашања на вашата компанија.',f2p:'Автоматски собирајте податоци, барања, резервации и термини.',f3p:'Управувајте со AI вработени, разговори, резервации, профил и пакет.',f4p:'Услужувајте клиенти низ Балканот без посебен тим за секој јазик.',f5p:'За хотели, апартмани, клиники, ресторани, недвижности и услужни компании.',f6p:'Вие одлучувате што знае AI, како зборува и кога разговорот го презема човек.',starterDesc:'1 AI вработен · Чат на веб-страница · Основни извештаи',businessDesc:'Повеќе канали · Резервации · Управување со контакти',professionalDesc:'Напредни автоматизации · Тимски пристап · Приоритетна поддршка',email:'Е-пошта'});
  Object.assign(translations.sl,{f1p:'Takojšnji odgovori na podlagi podatkov, storitev in pogostih vprašanj vašega podjetja.',f2p:'Samodejno zbirajte podatke strank, zahteve, rezervacije in termine.',f3p:'Upravljajte AI zaposlene, pogovore, rezervacije, profil podjetja in paket.',f4p:'Oskrbujte stranke po Balkanu brez posebne ekipe za vsak jezik.',f5p:'Za hotele, apartmaje, klinike, restavracije, nepremičnine in storitvena podjetja.',f6p:'Vi določate, kaj AI ve, kako govori in kdaj pogovor prevzame človek.',starterDesc:'1 AI zaposleni · Spletni klepet · Osnovna poročila',businessDesc:'Več kanalov · Rezervacije · Upravljanje kontaktov',professionalDesc:'Napredne avtomatizacije · Ekipni dostop · Prednostna podpora',email:'E-pošta'});
  Object.assign(translations.it,{f1p:'Risposte immediate basate su informazioni, servizi e domande frequenti della tua azienda.',f2p:'Raccogli automaticamente dati dei clienti, richieste, prenotazioni e appuntamenti.',f3p:'Gestisci dipendenti AI, conversazioni, prenotazioni, profilo aziendale e piano.',f4p:'Servi clienti in tutti i Balcani senza un team separato per ogni lingua.',f5p:'Per hotel, appartamenti, cliniche, ristoranti, immobili e aziende di servizi.',f6p:'Decidi cosa sa l’AI, come parla e quando la conversazione passa a una persona.',starterDesc:'1 dipendente AI · Chat sul sito · Report di base',businessDesc:'Più canali · Prenotazioni · Gestione contatti',professionalDesc:'Automazioni avanzate · Accesso team · Supporto prioritario',email:'Email'});
  Object.assign(translations.tr,{f1p:'Şirket bilgileriniz, hizmetleriniz ve sık sorulan sorularınıza dayalı anında yanıtlar.',f2p:'Müşteri bilgilerini, talepleri, rezervasyonları ve randevuları otomatik olarak toplayın.',f3p:'Yapay zekâ çalışanlarını, görüşmeleri, rezervasyonları, şirket profilini ve planı yönetin.',f4p:'Her dil için ayrı ekip kurmadan Balkanlar genelinde müşterilere hizmet verin.',f5p:'Oteller, daireler, klinikler, restoranlar, emlak ve hizmet şirketleri için.',f6p:'Yapay zekânın ne bildiğine, nasıl konuştuğuna ve görüşmenin ne zaman bir kişiye aktarılacağına siz karar verin.',starterDesc:'1 yapay zekâ çalışanı · Web sitesi sohbeti · Temel raporlar',businessDesc:'Birden fazla kanal · Rezervasyonlar · Müşteri adayı yönetimi',professionalDesc:'Gelişmiş otomasyonlar · Ekip erişimi · Öncelikli destek',email:'E-posta'});
